package io.javalin.javalin_project.controller;
...
public class UserController {
	...
	static {
		var tempMap = Map.of(randomId(), new User("Alice", "alice@alice.kt"), randomId(), new User("Bob", "bob@bob.kt"),
				randomId(), new User("Carol", "carol@carol.kt"), randomId(), new User("Dave", "dave@dave.kt"));
